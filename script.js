...
successMsg.innerHTML =   <div class="success-content">   <div class="success-icon">   <i class="fas fa-check-circle"></i>   </div>   <h4>Order Request Sent!</h4>   <p>Your order for "<strong>${itemName}</strong>" has been prepared.</p>   <p>Check WhatsApp to complete your order.</p>   <div class="success-tips">   <div class="tip">   <i class="fas fa-clock"></i>   <span>Response within 15 minutes</span>   </div>   <div class="tip">   <i class="fas fa-headset"></i>   <span>Customer support available</span>   </div>   </div>   <button class="btn-close-success">OK</button>   </div>  ;
...
statusMsg.innerHTML =   <i class="fas fa-${type === 'success' ? 'wifi' : 'exclamation-triangle'}"></i>   <span>${message}</span>  ;
...
මට ඕනෙ ඇඩ්මින් පැනල් එක ඇතුලේ පෙන්වන මෙනූ බටන් එක ක්ලික් කරාම ඕපන් වෙන පොපප් එක බැක් කරනකොට ෆෝන් එකේ navigation බාර් එකේ තියෙන බැක් බටන් එකෙන් බැක් වෙන්න හදන්න. ඒකට කොහොමද කරන්නෙ කෙටියෙන් kiyanna
